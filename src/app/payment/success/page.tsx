    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 font-sans">
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-4 py-16 text-center">
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-lg p-10 max-w-md w-full">
          ...
          <h1 className="text-2xl font-bold text-[#0f2a4a] dark:text-slate-100 mb-2">You are now a Pro member.</h1>
          <p className="text-gray-500 dark:text-slate-400 mb-8">Welcome to ForaHub Pro. Full access to the 24-month global SDG events calendar is yours.</p>
