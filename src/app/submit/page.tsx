      ...
      <main className="relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-12 md:py-16 lg:py-20 space-y-16 md:space-y-20">
          ...
          <section className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="mt-4 text-3xl md:text-5xl font-bold text-[#0f2a4a] tracking-tight leading-[1.1]">
          ...
          <section>
            <header className="text-center mb-8 md:mb-10">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0f2a4a] tracking-tight">
                Why organizations use ForaHub
              </h2>
...
function ChooserCard({
  ...
  return (
    <Link
      href={href}
      className="group relative bg-white rounded-2xl border border-gray-200/80 shadow-[0_1px_2px_rgba(15,42,74,0.04)] hover:shadow-[0_12px_30px_-12px_rgba(15,42,74,0.18)] hover:-translate-y-0.5 transition-all duration-200 p-7 md:p-8 flex flex-col h-full focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4ea8de]/40 focus-visible:border-[#4ea8de]"
...
function PillarCard({
  ...
  return (
    <div className="bg-white border border-gray-200/70 rounded-2xl p-6 md:p-7 shadow-[0_1px_2px_rgba(15,42,74,0.04)]">
      <div className="w-11 h-11 rounded-xl bg-[#0f2a4a]/5 flex items-center justify-center mb-4">
        <Icon className="w-5 h-5 text-[#0f2a4a]" aria-hidden="true" />
      </div>
      <h3 className="text-base md:text-lg font-bold text-[#0f2a4a] tracking-tight">{title}</h3>
